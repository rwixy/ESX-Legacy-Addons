---@type table<string, WeaponShopZone>
...
Config.Zones = {
	GunShop = {
		...
		Items = {
			...
			{ name = 'WEAPON_FLASHLIGHT',       price = 70 },
			{ name = 'WEAPON_MACHETE',          price = 110 },
			{ name = 'WEAPON_NIGHTSTICK',       price = 150 },
			{ name = 'WEAPON_BAT',              price = 50 },
			{ name = 'WEAPON_STUNGUN',          price = 60 },
			{ name = 'WEAPON_MICROSMG',         price = 1700 },
			{ name = 'WEAPON_ASSAULTRIFLE',     price = 11000 },
			{ name = 'WEAPON_SPECIALCARBINE',   price = 15000 },
			{ name = 'WEAPON_SNIPERRIFLE',      price = 24000 },
			{ name = 'WEAPON_FIREWORK',         price = 21000 },
			{ name = 'WEAPON_GRENADE',          price = 700 },
			{ name = 'WEAPON_BZGAS',            price = 200 },
			{ name = 'WEAPON_FIREEXTINGUISHER', price = 100 },
			{ name = 'WEAPON_BALL',             price = 30 },
