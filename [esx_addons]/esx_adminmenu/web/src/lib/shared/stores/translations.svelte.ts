...
const defaultTranslations: Translations = {
	...
	quick_menu_hint: "Arrow keys move, Tab changes tabs, Enter runs, Backspace closes.",
	quick_menu_edit_hint: "Tab changes tabs, left/right change values, Enter selects.",
	back: "Back",
	kick: "Kick",
	ban: "Ban",
	never: "Never",
...
export const translations = new TranslationState();
